...
$( document ).on( "click", "#cost-calculate-modal span.close", function() { 
    ...
    $(document).ready(function(){
        ...
        var sectionIds = $('a.content-area-left__list-option');
        ...
        var sectionIds1 = $('li.filter-type__option-item');
        $(document).scroll(function(){
            ...
            sectionIds1.each(function(){
                ...
                if(scrollPosition < containerBottom - 20 && scrollPosition >= containerOffset - 20){
                    ...
                    if(containerText != "")
                        $("fieldset #conditional-experience-field span").html(containerText);
                } else{
  ...
  $("ul[role='listbox'] li").click(function () {
    var t8 = $(this).text().trim();
    var href_ele = $(this).attr('href');
    console.log(t8);
    setTimeout(function () {
      obj = $("fieldset button");
      obj.find("span").text(t8);
      obj.attr({ "aria-expanded": "false" });
      obj.next().removeClass("show");
      obj.attr({ "aria-expanded": "false" });

        $('html, body').animate({
            scrollTop: $(href_ele).offset().top - 100
        }, 100);
...
document.onkeyup = function(evt) {
    ...
    if (isEscape) {
        $("ul[role='listbox']").removeClass('show');
        $(".dropdown-menu").removeClass('show').hide();
    }   
};

window.onclick = function(event) {
    var modal = document.getElementById("conditional-experience-field");
    if (event.target == modal) {
        $("#postcode-bottom-sheet-drawer").hide();
    }else {
        $("ul[role='listbox']").removeClass('show');
    ...
    var modal2 = document.getElementsByClassName("dropdown-menu");
    if (event.target == modal) {
        var t = 1;
    }else {
        $(".dropdown-menu").removeClass('show').hide();
...
if($('.content-area-right__how-does-works-points-btn').length>0){
    $('.content-area-right__how-does-works-points-btn').click(function() {

        $('.content-area-right__how-does-works-points-btn').removeAttr("data-state");
    ...
    $('.content-area-right__how-does-works-points-btn').trigger('click');
}

if($('.content-panel-item').length>0){
    $('.content-panel-item').click(function() {

        $(this).toggleAttrVal('data-state', "active", "false");
