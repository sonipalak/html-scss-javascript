...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.container.on( "click", "button.closeBtnDate", function() { $("button.cancelBtn").trigger("click"); });
        this.container.on( "click", ".overlay__date", function() { $("button.cancelBtn").trigger("click"); });

      //  this.container.on( "click", ".closeBtnDate2.close", function() {  console.log("click 448"); /*this.hideEndDate();*/ });
    ...
    DateRangePicker.prototype = {
        ...
        setStartDate: function(startDate) {
            ...
            $(".date-indicator.startdate span.date").html(this.startDate.format('DD MMM'));
            $(".date-indicator.startdate span.day").html(this.startDate.format('dddd').substring(0,3));
            $(".date-indicator").removeClass('active');
            $(".date-indicator.startdate").addClass('active');
            
            this.updateMonthsInView();
            console.log("call 508");
            setTimeout(() => {
        ...
        setEndDate: function(endDate) {
            ...
            this.container.find('.drp-selected').html('<div class="date-range"><div class="date-indicator startdate"><div class="date-day"><p>Start</p><span class="date">'+this.startDate.format('DD MMM') +'</span></div><em class="closeBtnDate2 start"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="12" fill="#9E9E9E"/><path d="M16.5515 16.5535L7.44531 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/><path d="M7.44531 16.5535L16.5515 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/></svg></em></div><div class="date-indicator enddate active"><div class="date-day"><p>End</p><span class="date">'+ this.endDate.format('DD MMM')+'</span></div><em class="closeBtnDate2 close"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="12" fill="#9E9E9E"/><path d="M16.5515 16.5535L7.44531 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/><path d="M7.44531 16.5535L16.5515 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/></svg></em></div></div>');

            
            $(".date-indicator.enddate span.date").html(this.endDate.format('DD MMM'));
            $(".date-indicator.enddate span.day").html(this.endDate.format('dddd').substring(0,3));
            setTimeout( function(){ 
                $(".date-indicator").removeClass('active');
                $(".date-indicator.enddate").addClass('active');
            }  , 100 );
            if (!this.isShowing)
                this.updateElement();
        ...
        updateView: function() {
            ...
            if (this.endDate)
                this.container.find('.drp-selected').html('<div class="date-range"><div class="date-indicator startdate"><div class="date-day"><p>Start</p><span class="date">'+this.startDate.format('DD MMM') +'</span></div><em class="closeBtnDate2 start"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="12" fill="#9E9E9E"/><path d="M16.5515 16.5535L7.44531 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/><path d="M7.44531 16.5535L16.5515 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/></em></div><div class="date-indicator enddate"><div class="date-day"><p>End</p><span class="date">'+ this.endDate.format('DD MMM')+'</span></div><em class="closeBtnDate2 close"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="12" fill="#9E9E9E"/><path d="M16.5515 16.5535L7.44531 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/><path d="M7.44531 16.5535L16.5515 7.44727" stroke="white" stroke-width="1.7" stroke-linecap="round"/></svg></em></div></div>');
            this.updateMonthsInView();
        ...
        updateCalendars: function() {
            ...
            if(screen.width < 600) {
                console.log("669");
                for (let monthItem = 0; monthItem < 6; monthItem++) {
                    if(monthItem % 2 == 0) {
                        this.renderCalendar('left', true, monthItem);
                    }
                    else {
                        this.renderCalendar('right', true, monthItem);
                    }
        ...
        renderCalendar: function(side, multiple, iterator) {
          ...
          //  console.log("here");
            ...
            if(multiple) {
                // $(html).appendTo(this.container.find('.calender__wrapper'));
                this.container.find('.calender__wrapper').append(html);
                // this.container.find('.calender__wrapper').insertAdjacentElement("beforeend", html);
           ...
           // this.container.find('.drp-calendar.' + side + ' .calendar-table').append(html);
        ...
        show: function(e) {
            ...
            setTimeout( function(){ 
                $('.today').removeClass('start-date').removeClass('active').removeClass('end-date');
            }  , 0.01 );
